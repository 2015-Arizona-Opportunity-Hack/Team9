...
app.controller('pageController', function($scope, $http, eventFactory, volunteerFactory){
  ...
  $scope.pages = {
    1: {
      name: "Food Bank",
      page: 1,
      content: "Each year CCCC distributes over 15,000 food boxes with enough food to feed over 50,000 adults and children. Persons needing emergency food are referred by a variety of agencies but primarily by the CAP (Community Action Program) office. Other referrals come from Child Protective Services, non profits, churches, schools, the Chandler Police Department’s Victim Services and the Chandler Fire Department. Emergency Food Boxes Tailored to family size and special dietary needs including infants, children, and homeless individuals. Emergency Food Distribution: Monday – 12:00 through 3:00 pm Tuesday, Wednesday and Thursday – 9:00 through 12:00 pm Supplemental Food Boxes Distributed weekly containing fresh perishable food Supplemental Food Distribution: Every Friday – 9:00 through 11:00 Food Donations Food is donated from local grocers and restaurants, individuals, clubs, businesses, faith organizations and more. Federal food comes through the United Food Bank. All donations are accepted during business hours. Please contact the office for special arrangements."
    },
    2: {
